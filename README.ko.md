...
**본인이 한 일:** 요구사항 정의, 최종 코드·설정 검토, Beanstalk/RDS/Vercel 직접 조작, 시드·배포 검증.  
**AI에 맡기지 않은 것:** 리밸런싱·지표 **비즈니스 로직의 최종 설계**, 프로덕션 **비밀번호·환경 변수** 관리.

포트폴리오·면접에서는 “AI로 전부 생성”보다 **도구를 쓰되 이해하고 고친 결과물**이라고 보는 편이 자연스럽습니다.
